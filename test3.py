...
def stageMenu():
    ...
    while True:
        ...
        button("Stage 1",560,250,500,50,green,bright_green,level1)
        button("Stage 2",560,350,500,50,green,bright_green,level2)
        button("Stage 3",560,450,500,50,green,bright_green,level3)
